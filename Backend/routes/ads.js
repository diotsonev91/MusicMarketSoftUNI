...
const { createAd, deleteAd, editAd, getAdById, getAllAdsOfUser, getAllAds, getAdByCategoryThenSubcategory,  getAdByPriceRange,
    getAdByCategoryThenSubcategoryThenPriceRange, searchAds,
    getAdByCategoryAndPriceRange, } = require("../controllers/ad");
...
router.get("/category/:category/price-range", getAdByCategoryAndPriceRange); // Ads by category, subcategory, and price range
...
router.get("/search", searchAds); // <-- Add the search route here
