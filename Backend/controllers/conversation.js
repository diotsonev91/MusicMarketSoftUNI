...
exports.deleteConversation = async (req, res) => {
  try {
    const conversationId = req.params.id; // Conversation ID from the request
    const userId = req.user.id; // Current user ID from authentication middleware
...
exports.markAsRead = async (req, res) => {
  try {
    ...
    console.log(
      "Is conversationId valid ObjectId:",
